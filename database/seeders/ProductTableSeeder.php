...
class ProductTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $fashionProducts = [
            [
                'info'       => [
                    'name'             => ['en' => 'Classic Sweatshirt', 'ar' => 'Classic Sweatshirt'],
                    'category'         => 3,
                    'brand'            => 1,
                    'group'            => 1,
                    'banner'           => 1,
            ...
            [
                'info'       => [
                    'name'             => ['en' => 'Classics French Men\'s Hoodie', 'ar' => 'Classics French Men\'s Hoodie'],
                    'category'         => 3,
                    'brand'            => 2,
                    'group'            => 1,
                    'banner'           => 1,
            ...
            [
                'info'       => [
                    'name'             => ['en' => 'Team Red Hoodie', 'ar' => 'arabic product name'],
                    'category'         => 3,
                    'brand'            => 3,
                    'group'            => 1,
                    'banner'           => 1,
        ...
        if ($envService->getValue('DEMO') && $envService->getValue('DISPLAY') == 'fashion') {
            foreach ($fashionProducts as $fashionProduct) {
                $productObject = Product::create([
                    ...
                    'slug'                         => Str::slug($fashionProduct['info']['name']['en'] . rand(1, 1000)),
                ...
                if (isset($fashionProduct['seo'])) {
                    ...
                    if (isset($fashionProduct['images']) && count($fashionProduct['images'])) {
                        if (file_exists(public_path('/images/seeder/product/' . env('DISPLAY') . '/' . $fashionProduct['image_path'] . '/' . strtolower(str_replace(' ', '_', $fashionProduct['info']['name']['en'])) . '/' . '1.png'))) {
                            $productSeo->addMedia(public_path('/images/seeder/product/' . env('DISPLAY') . '/' . $fashionProduct['image_path'] . '/' . strtolower(str_replace(' ', '_', $fashionProduct['info']['name']['en'])) . '/' . '1.png'))->preservingOriginal()->toMediaCollection('product-seo');
                        }
                    }
                }
                ...
                if (isset($fashionProduct['images']) && count($fashionProduct['images'])) {
                    foreach ($fashionProduct['images'] as $image) {
                        if (file_exists(public_path('/images/seeder/product/' . env('DISPLAY') . '/' . $fashionProduct['image_path'] . '/' . strtolower(str_replace(' ', '_', $fashionProduct['info']['name']['en'])) . '/' . $image . '.png'))) {
                            $productObject->addMedia(public_path('/images/seeder/product/' . env('DISPLAY') . '/' . $fashionProduct['image_path'] . '/' . strtolower(str_replace(' ', '_', $fashionProduct['info']['name']['en'])) . '/' . $image . '.png'))->preservingOriginal()->toMediaCollection('product');
                        }
                    }
                }
            }
